...
urlpatterns = [
    ...
    path("obtener/instalaciones/actividades/", views.ObtenerActividadesInstalaciones.as_view(), name="favoritas"),
    path("obtener/favoritas/", views.ObtenerActividadesInstalacionesFavoritas.as_view(), name="favoritas"),
