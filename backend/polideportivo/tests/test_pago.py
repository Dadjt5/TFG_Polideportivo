...
class PagoTests(TestCase):
    def setUp(self):
        ...
        self.user = User.objects.create_user(username="user1", email="test@test.com", password="1234")
    ...
    def test_contar(self):
        Pago.objects.create(concepto="P1", usuarioFinal=self.usuario, content_type=self.content_type, object_id=1)
        Pago.objects.create(concepto="P2", usuarioFinal=self.usuario, content_type=self.content_type, object_id=1)
    ...
    def test_aplicarPagoUnico(self, intent_mock):
        ...
        pago = Pago.nuevoPago("Test", self.usuario, TipoPago.UNICO, self.objeto)
        intent = pago.aplicarPagoUnico(self.usuario)
    ...
    def test_aplicarSubscripcion(self, customer_mock, price_mock, sub_mock):
        ...
        sub = pago.aplicarSubscripcion(self.usuario)
