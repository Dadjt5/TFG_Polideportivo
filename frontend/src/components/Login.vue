        ...
        <div class="col-md-7 col-lg-5">
          ...
          <div class="card border-0 rounded-4 p-4 mx-auto"
            ...
            <div class="mb-3 position-relative">
              <input type="text" class="form-control py-2 rounded-3" :placeholder="t.identifierPlaceholder"
                v-model="identifier" @keyup.enter="handleLogin" />
            </div>
            ...
            <!-- Login button -->
            <button class="btn btn-primary w-100 py-2 fs-5 rounded-3 mb-2" @click="handleLogin" :disabled="loading">
              {{ t.loginPage }}
            </button>

            <!-- Forgot password -->
            <router-link to="/recuperar-password" class="btn btn-link w-100 text-decoration-none text-primary mb-3">
              {{ t.forgotPassword }}
            </router-link>
